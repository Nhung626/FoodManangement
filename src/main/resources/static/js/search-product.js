                ...
                success: function (response) {
                    ...
                    for (let i = 0; i < response.length; i++) {
                        let html = ` <div class="col-md-3">
                            <div class="card mb-3">
                                <img src="${response[i].imageId}?token=${localStorage.getItem('token')}" class="card-img-top rounded mx-auto d-block product-image" style="width: 200px; height: 200px; object-fit: cover;" onerror="this.onerror=null; this.src='https://ih1.redbubble.net/image.485923678.1240/flat,750x,075,f-pad,750x1000,f8f8f8.u4.jpg'">
